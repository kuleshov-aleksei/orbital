<template>
  <div class="text-center">
    ...
    <p class="text-sm text-gray-400 mb-4">
      Enter the 6-digit code by rotating the dial
    </p>
    ...
    <div v-if="!isCompleted" class="flex flex-col items-center">
      ...
      <div class="rotary-container relative w-64 h-64 mb-4">
        <!-- Outer ring -->
        <div class="rotary-ring absolute inset-0 rounded-full bg-gradient-to-b from-gray-700 to-gray-800 border-4 border-gray-600 shadow-lg">
          <!-- Fixed indicator at top -->
          <div class="indicator absolute -top-2 left-1/2 -translate-x-1/2 z-10">
            <div class="w-0 h-0 border-l-[12px] border-l-transparent border-r-[12px] border-r-transparent border-t-[16px] border-t-red-500"></div>
          </div>
          <!-- Current number indicator -->
          <div class="current-number absolute -top-8 left-1/2 -translate-x-1/2 bg-red-500 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold text-lg shadow-lg z-10">
            {{ currentDialNumber }}
          </div>
          <!-- Rotating dial -->
          <div 
          ...
          >
            <!-- Center hole -->
            <div class="center-hole absolute w-20 h-20 bg-gray-800 rounded-full border-4 border-gray-700 flex items-center justify-center shadow-inner"
      ...
      <Transition name="fade">
        <div v-if="showError" class="mt-4 text-red-500 font-bold">
