    ...
    <div class="relative flex items-center justify-center bg-black w-full h-full">
      ...
      <div class="absolute top-0 left-0 right-0 bg-gradient-to-b from-black/70 to-transparent px-3 py-2">
        <div class="flex items-center justify-between">
          ...
          <!-- Self-view indicator -->
          <div v-if="isSelfView" class="text-xs text-indigo-300 bg-indigo-900/50 px-2 py-0.5 rounded">
            You
          </div>
        </div>
      </div>
...
import { PhArrowsOut, PhArrowsIn, PhPictureInPicture, PhSpinner, PhCameraSlash } from "@phosphor-icons/vue"
